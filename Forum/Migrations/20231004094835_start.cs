        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReplyToComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeReplyToComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikeReplyToComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LikeReplyToComments_ReplyToComments_ReplyId",
                        column: x => x.ReplyId,
                        principalTable: "ReplyToComments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikeReplyToComments_ReplyId",
                table: "LikeReplyToComments",
                column: "ReplyId");

            migrationBuilder.CreateIndex(
                name: "IX_LikeReplyToComments_UserId",
                table: "LikeReplyToComments",
                column: "UserId");
